<x-app-layout>
    ...
    @if($deals->count() > 0) 
        ...
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow ">
            ...
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-yellow-700 rounded-lg hover:bg-amber-900 focus:ring-4 focus:outline-none focus:ring-pink-300 ">
                View Offer
